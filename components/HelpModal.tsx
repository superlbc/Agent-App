          ...
          <div className="p-5">
            ...
            <div className="flex justify-between items-start mb-6">
              <div className="space-y-1">
                <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Help & Guidance</h2>
              ...
              <button
                onClick={onClose}
                className="-mt-2 -mr-2 p-2 rounded-full hover:bg-slate-100 dark:hover:bg-slate-800 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary transition-colors"
    ...
    <section className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border border-blue-200 dark:border-blue-800">
      ...
      <ol className="space-y-3 list-decimal list-inside text-slate-700 dark:text-slate-300">
        <li className="pl-2">
          ...
          <p className="ml-6 mt-1 text-slate-600 dark:text-slate-400">
    ...
    <section>
      ...
      <div className="space-y-4">
        ...
        <div className="border-l-4 border-blue-400 pl-4">
          <h4 className="font-medium text-slate-900 dark:text-white mb-1">📋 Meeting Title</h4>
        ...
        <div className="border-l-4 border-green-400 pl-4">
          <h4 className="font-medium text-slate-900 dark:text-white mb-1">📝 Agenda</h4>
          ...
          <div className="mt-2 bg-slate-100 dark:bg-slate-800 rounded p-2 text-xs font-mono">
        ...
        <div className="border-l-4 border-purple-400 pl-4">
          <h4 className="font-medium text-slate-900 dark:text-white mb-1">💬 Transcript</h4>
          <ul className="text-slate-600 dark:text-slate-400 space-y-1">
        ...
        <div className="border-l-4 border-amber-400 pl-4">
          <h4 className="font-medium text-slate-900 dark:text-white mb-1">🏷️ Context Tags</h4>
    ...
    <section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        <div className="border border-slate-200 dark:border-slate-700 rounded-lg p-3">
          <div className="font-medium text-slate-900 dark:text-white mb-1">🤝 Client Update</div>
          <p className="text-xs text-slate-600 dark:text-slate-400">
            Professional tone, redaction enabled, gentle coaching
          </p>
        </div>
        <div className="border border-slate-200 dark:border-slate-700 rounded-lg p-3">
          <div className="font-medium text-slate-900 dark:text-white mb-1">💼 Internal Sync</div>
          <p className="text-xs text-slate-600 dark:text-slate-400">
            Balanced tone, critical lens, direct coaching
          </p>
        </div>
        <div className="border border-slate-200 dark:border-slate-700 rounded-lg p-3">
          <div className="font-medium text-slate-900 dark:text-white mb-1">💡 Brainstorm</div>
          <p className="text-xs text-slate-600 dark:text-slate-400">
            Concise format, captures all ideas, bold keywords
          </p>
        </div>
        <div className="border border-slate-200 dark:border-slate-700 rounded-lg p-3">
          <div className="font-medium text-slate-900 dark:text-white mb-1">📊 Executive Briefing</div>
          <p className="text-xs text-slate-600 dark:text-slate-400">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <p className="text-xs text-slate-600 dark:text-slate-400">Rich text format, ready to paste</p>
          </div>
        </div>
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <p className="text-xs text-slate-600 dark:text-slate-400">Professional document format</p>
          </div>
        </div>
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <p className="text-xs text-slate-600 dark:text-slate-400">Import actions to project tools</p>
          </div>
        </div>
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <p className="text-xs text-slate-600 dark:text-slate-400">Pre-formatted email template</p>
          </div>
        </div>
      </div>
    </section>
...
const TipsTab: React.FC = () => (
  <div className="space-y-6 text-sm">
    ...
    <section>
      <h3 className="font-semibold text-lg mb-3 flex items-center gap-2">
        <Icon name="info" className="h-5 w-5 text-slate-500" />
        ⌨️ Keyboard Shortcuts
      </h3>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        <div className="flex items-center justify-between p-2 bg-slate-50 dark:bg-slate-800 rounded">
          <span className="text-slate-700 dark:text-slate-300">Generate Notes</span>
          <kbd className="px-2 py-1 text-xs bg-slate-200 dark:bg-slate-700 rounded border border-slate-300 dark:border-slate-600">
            Alt + G
          </kbd>
        </div>
        <div className="flex items-center justify-between p-2 bg-slate-50 dark:bg-slate-800 rounded">
          <span className="text-slate-700 dark:text-slate-300">Clear Form</span>
          <kbd className="px-2 py-1 text-xs bg-slate-200 dark:bg-slate-700 rounded border border-slate-300 dark:border-slate-600">
            Alt + K
          </kbd>
        </div>
        <div className="flex items-center justify-between p-2 bg-slate-50 dark:bg-slate-800 rounded">
          <span className="text-slate-700 dark:text-slate-300">Open File Upload</span>
          <kbd className="px-2 py-1 text-xs bg-slate-200 dark:bg-slate-700 rounded border border-slate-300 dark:border-slate-600">
            Alt + O
          </kbd>
        </div>
        ...
        <div className="flex items-center justify-between p-2 bg-slate-50 dark:bg-slate-800 rounded">
          <span className="text-slate-700 dark:text-slate-300">Copy to Clipboard</span>
          <kbd className="px-2 py-1 text-xs bg-slate-200 dark:bg-slate-700 rounded border border-slate-300 dark:border-slate-600">
            Alt + C
          </kbd>
        </div>
        <div className="flex items-center justify-between p-2 bg-slate-50 dark:bg-slate-800 rounded">
          <span className="text-slate-700 dark:text-slate-300">Export PDF</span>
          <kbd className="px-2 py-1 text-xs bg-slate-200 dark:bg-slate-700 rounded border border-slate-300 dark:border-slate-600">
            Alt + P
          </kbd>
        </div>
        <div className="flex items-center justify-between p-2 bg-slate-50 dark:bg-slate-800 rounded">
          <span className="text-slate-700 dark:text-slate-300">Download CSV</span>
          <kbd className="px-2 py-1 text-xs bg-slate-200 dark:bg-slate-700 rounded border border-slate-300 dark:border-slate-600">
            Alt + S
          </kbd>
        </div>
        <div className="flex items-center justify-between p-2 bg-slate-50 dark:bg-slate-800 rounded">
          <span className="text-slate-700 dark:text-slate-300">Interrogate Transcript</span>
          <kbd className="px-2 py-1 text-xs bg-slate-200 dark:bg-slate-700 rounded border border-slate-300 dark:border-slate-600">
            Alt + I
          </kbd>
        </div>
        <div className="flex items-center justify-between p-2 bg-slate-50 dark:bg-slate-800 rounded">
          <span className="text-slate-700 dark:text-slate-300">Close Modal</span>
          <kbd className="px-2 py-1 text-xs bg-slate-200 dark:bg-slate-700 rounded border border-slate-300 dark:border-slate-600">
            Esc
          </kbd>
        </div>
        <div className="flex items-center justify-between p-2 bg-slate-50 dark:bg-slate-800 rounded">
          <span className="text-slate-700 dark:text-slate-300">Open Settings</span>
          <kbd className="px-2 py-1 text-xs bg-slate-200 dark:bg-slate-700 rounded border border-slate-300 dark:border-slate-600">
            Alt + ,
          </kbd>
        </div>
        <div className="flex items-center justify-between p-2 bg-slate-50 dark:bg-slate-800 rounded">
          <span className="text-slate-700 dark:text-slate-300">Replay Tour</span>
          <kbd className="px-2 py-1 text-xs bg-slate-200 dark:bg-slate-700 rounded border border-slate-300 dark:border-slate-600">
            Alt + T
          </kbd>
        </div>
    ...
    <section className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-lg p-4">
      ...
      <div className="grid grid-cols-2 gap-4 text-xs">
        <div>
          ...
          <div className="text-slate-600 dark:text-slate-400">Use Actions Only view + Internal Sync preset</div>
        </div>
        <div>
          <div className="font-medium mb-1">For Client Meetings:</div>
          <div className="text-slate-600 dark:text-slate-400">Use Client Update preset + Enable redaction</div>
        </div>
        <div>
          <div className="font-medium mb-1">For Strategic Sessions:</div>
          <div className="text-slate-600 dark:text-slate-400">Enable Critical Lens + Meeting Coach</div>
        </div>
        <div>
          <div className="font-medium mb-1">For Brainstorms:</div>
          <div className="text-slate-600 dark:text-slate-400">Use Brainstorm preset + Bold keywords</div>
        </div>
      </div>
    </section>
  </div>
